...
public interface RequestListener {
	/**
	 * Provides the current progress from 0 (not started, never actually sent)
	 * to 1 (finished and will not called again) as well as an opportunity for
	 * the client to cancel the request. Other parameters represent the property
