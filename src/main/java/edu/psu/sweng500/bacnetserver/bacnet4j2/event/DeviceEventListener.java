 ...
 * thread so that client code need not be concerned with completing its
 * processing in any timely manner. The "sync" version runs within the
 * dispatching thread, and so MUST return as quickly as possible. In particular,
 * overrides of the sync methods MUST NOT send requests.
 * 
 * @author Matthew
 */
