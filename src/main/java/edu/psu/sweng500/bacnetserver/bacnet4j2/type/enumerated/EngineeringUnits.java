...
public class EngineeringUnits extends Enumerated {
	...
	public static final EngineeringUnits[] ALL = { squareMeters, squareFeet, milliamperes, amperes, ohms, volts,
			...
			cyclesPerMinute, hertz, gramsOfWaterPerKilogramDryAir, percentRelativeHumidity, millimeters, meters, inches,
			feet, wattsPerSquareFoot, wattsPerSquareMeter, lumens, luxes, footCandles, kilograms, poundsMass, tons,
			kilogramsPerSecond, kilogramsPerMinute, kilogramsPerHour, poundsMassPerMinute, poundsMassPerHour, watts,
			kilowatts, megawatts, btusPerHour, horsepower, tonsRefrigeration, pascals, kilopascals, bars,
			...
			feetPerMinute, milesPerHour, cubicFeet, cubicMeters, imperialGallons, liters, usGallons, cubicFeetPerMinute,
			cubicMetersPerSecond, imperialGallonsPerMinute, litersPerSecond, litersPerMinute, usGallonsPerMinute,
			degreesAngular, degreesCelsiusPerHour, degreesCelsiusPerMinute, degreesFahrenheitPerHour,
			degreesFahrenheitPerMinute, noUnits, partsPerMillion, partsPerBillion, percent, percentPerSecond, perMinute,
			perSecond, psiPerDegreeFahrenheit, radians, revolutionsPerMinute, currency1, currency2, currency3,
			currency4, currency5, currency6, currency7, currency8, currency9, currency10, squareInches,
			squareCentimeters, btusPerPound, centimeters, poundsMassPerSecond, deltaDegreesFahrenheit,
