...
public class HeaderCRC {
	...
	public static void main(String[] args) {
		...
		// crc.getCrc(new Frame(FrameType.bacnetDataNotExpectingReply, (byte)
		// 0xff, (byte) 8, new byte[] { 0x1,
		// 0x20, (byte) 0xff, (byte) 0xff, 0x0, (byte) 0xff, 0x10, 0x0, (byte)
		// 0xc4, 0x2, 0x4, 0x3a, 0x10,
		// 0x22, 0x1, (byte) 0xe0, (byte) 0x91, 0x3, 0x22, 0x1, 0x15 })), 16));
		// System.out.println(Integer.toString(crc.close(), 16));

		HeaderCRC crc = new HeaderCRC();
		int frameCrc = crc.getCrc(new Frame(FrameType.bacnetDataNotExpectingReply, (byte) 0xff, (byte) 8,
				new byte[] { 0x1, 0x20, (byte) 0xff, (byte) 0xfc, (byte) 0xfe, 0x20, (byte) 0xa0, (byte) 0xe7,
